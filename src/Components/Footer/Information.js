    ...
    return (
        <>
            ...
            <p className="information-text">
                ...
                incorrect or defective item, etc.). <br />
                <br /> You should expect to receive your refund within four
                ...
                to process your return once we receive it (3 to 5 business
                days), and the time it takes your bank to process our refund
                request (5 to 10 business days).
                <br />
                <br /> If you need to return an item, simply login to your
                ...
                <br />
                <br /> We can ship to virtually any address in the world. Note
