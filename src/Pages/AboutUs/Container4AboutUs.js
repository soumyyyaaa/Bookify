        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <FontAwesomeIcon
              ...
              size="l"
            />
            <h5 className="testimonial-name-aboutus">Krist Watson</h5>
            <h6>Actor</h6>
          </div>
          ...
          <div className="carousel-item">
            ...
            <p className="testimonial-aboutus">
              Pellentesque posuere orci lobortis scelerisque blandit. Donec id
              tellus lacinia an, tincidunt risus ac, consequat velit. Quisquemos
              sodales suscipit tortor ditaemcos condimentum
            </p>
            <FontAwesomeIcon
              icon={faStar}
              style={{ color: "#d14031" }}
