                        ...
                        <div className="container-grid-aboutus">
                            ...
                            <div className="grid-item">
                                ...
                                <p className="para-aboutus">
                                    Viverra justo nec ultrices dui. Sit amet
                                    volutpat consequat mauris nunc congue nisi
                                    vitae. Lorem ipsum dolor sit amet. Sit amet
                                    consectetur adipiscing elit duis tristique
                                    sollicitudin nibh. Diam maecenas ultricies
                                    mi eget. . <br /> <br />
                                    Integer quis auctor elit sed vulputate mi
                                    sit amet mauris. Quam lacus suspendisse
                                    faucibus interdum posuere lorem. Nibh tellus
                                    molestie nunc non blandit massa enim nec
                                    dui. Suspendisse in est ante in nibh mauris.
                                </p>
                            </div>
                            <img
                                src={aboutUsImg2}
                            ...
                            <div className="grid-item-right">
                                ...
                                <p className="para-aboutus">
                                    ...
                                    hendrerit lectus. Accumsan tortor posuere ac
                                    ut consequat semper viverra. Pellentesque
                                    habitant morbi tristique senectus et netus
                                    et malesuada. Accumsan sit amet.
                                    <br /> <br /> Porem ipsum dolor sit amet,
                                    consectetur adipiscing elit, sed do eiusmod
                                    tempor incididunt ut labore et dolore magna
                                    aliqua. Pellentesque nec nam aliquam sem et.
                                    Cras sed felis eget velit aliquet lacus
                                    faucibus non est.
                                </p>
                            </div>
                            <img
                            ...
                            <div className="grid-item">
                                ...
                                <p className="para-aboutus">
                                    ...
                                    rutrum quisque. Malesuada nunc vel risus
                                    commodo viverra maecenas. At lectus urna
                                    duis convallis. Bibendum neque egestas
                                    congue quisque egestas diam. Volutpat
                                    commodo. <br />
                                    <br /> Cursus vitae congue mauris rhoncus
                                    aenean. Laoreet non curabitur gravida arcu
                                    ac tortor. Luctus venenatis lectus magna
