        ...
        <div>
            ...
            <div className="container1-home">
                <div className="text-container-home">
                    ...
                    <p>
                        From type to logo design, the best graphic design books
                        will take you on a journey to mastering your craft. best
            ...
            <div className="container7-home">
                <div className="special-offers-text">
                    ...
                    <p
                        ...
                        style={{ color: "#707070" }}
                    >
                        Online shopping for Language Learning & Teaching from a
                        great selection at Books ... Language, Linguistics &
                        Writing ... vashista 360 spoken english book.
                    </p>
            ...
            <div className="container12-home">
                ...
                <p style={{ color: "#707070", margin: "3% auto" }}>
                    ...
                    as news on upcoming events and speciic offers.
                </p>
