            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="container2-blogs">
                        <Link to="/bcmi" style={{ textDecoration: "none" }}>
                            <div className="container2-content">
                                ...
                                >
                                    ...
                                    aenean pharetra magna ac. Eu ultrices vitae
                        ...
                        <Link to="/bwo19c" style={{ textDecoration: "none" }}>
                            <div className="container2-content">
                                ...
                                >
                                    ...
                                    Posuere urna nec tincidunt praesent. Tempus
                                    iaculis urna id volutpat. Sapien nec
                                    sagittis aliq sdis nesst swes.
                                </p>
                                <button className="read-more-blogs">
                                    Read More
                                </button>
                        ...
                        <Link to="/bksb" style={{ textDecoration: "none" }}>
                            <div className="container2-content">
                                ...
                                >
                                    ...
                                    ipsum suspendisse ultrices. In massa tempor
                                    nec feugiat nisl pretium fusce id. Sit amet
                                    dictum.
                                </p>
                                <button className="read-more-blogs">
                                    Read More
                        ...
                        <Link to="/bcnw" style={{ textDecoration: "none" }}>
                            <div className="container2-content">
                                ...
                                >
                                    Consequat id porta nibh venenatis. In
                        ...
                        <Link to="/ncoh" style={{ textDecoration: "none" }}>
                            <div className="container2-content">
                                ...
                                >
                                    ...
                                    tristique sollicitudin nibh sit. Neque
                                    convallis a cras semper auctor neque vitae.
                                    Leo duis ut diam qua.
                                </p>
                                <button className="read-more-blogs">
                                    Read More
                                </button>
                        ...
                        <Link to="/t5asc" style={{ textDecoration: "none" }}>
                            <div className="container2-content">
                                ...
                                >
                                    ...
                                    viverra maecenas. Gravida quis blandit
                                    turpis cursus in.
                                </p>
                                <button className="read-more-blogs">
                                    Read More
