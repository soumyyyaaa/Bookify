      ...
      <div className="container2-blogs">
        <Link to="/bcmi" style={{ textDecoration: "none" }}>
          <div className="container2-content">
            ...
            <p
              className="sans-serif-font"
              style={{ color: "#707070", margin: "3% 0", textAlign: "justify" }}
            >
        ...
        <Link to="/bwo19c" style={{ textDecoration: "none" }}>
          <div className="container2-content">
            ...
            >
              ...
              praesent. Tempus iaculis urna id volutpat. Sapien nec sagittis
              aliq sdis nesst swes.
            </p>
            <button className="read-more-blogs">Read More</button>
          </div>
        </Link>
        ...
        <Link to="/ncoh" style={{ textDecoration: "none" }}>
          <div className="container2-content">
            ...
            >
              ...
              nibh sit. Neque convallis a cras semper auctor neque vitae. Leo
              duis ut diam qua.
            </p>
            <button className="read-more-blogs">Read More</button>
          </div>
