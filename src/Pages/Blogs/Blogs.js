            ...
            <div className="container2-blogs">
                ...
                <Link to="/bcnw" style={{ textDecoration: "none" }}>
                    <div className="container2-content">
                        ...
                        >
                            Consequat id porta nibh venenatis. In fermentum et
                            sollicitudin ac orci phasellus. Pellentesque diam
                            volutpat commodo sed egestas egesta.
                        </p>
                        <button className="read-more-blogs">Read More</button>
                    </div>
                </Link>
                <Link to="/ncoh" style={{ textDecoration: "none" }}>
                    <div className="container2-content">
                        ...
                        >
                            ...
                            sollicitudin nibh sit. Neque convallis a cras semper
                            auctor neque vitae. Leo duis ut diam qua.
                        </p>
                        <button className="read-more-blogs">Read More</button>
                    </div>
                </Link>
                <Link to="/t5asc" style={{ textDecoration: "none" }}>
                    <div className="container2-content">
                        ...
                        >
                            Maecenas volutpat blandit aliquam etiam. Integer
