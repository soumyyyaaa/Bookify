  ...
  return (
    <>
      ...
      <div className="container1-contact-us">
        <div className="contact-us-box">
          ...
          <p className="contact-us-para">
            Toll-Free: 0803 - 080 - 3081 <br /> Fax: 0803 - 080 - 3082
          </p>
        </div>
        <div className="contact-us-box">
          <button className="contact-us-icons">
      ...
      <div className="container2-contact-us">
        <form>
            <input className="contact-us-form" placeholder="Name" type="text" /> <br />
            <input className="contact-us-form" placeholder="Email" type="email" /> <br />
            <input className="contact-us-form" placeholder="Phone Number" type="tel" size='10' maxLength='10' /> <br />
            <input className="contact-us-form" placeholder="Comment" type="text" /> <br />
            <input className="contact-us-button" type="submit" value='Send' />
        </form>
